...
5:                                                ; preds = %1
  %6 = call i32 (ptr, ...) @printf(ptr noundef @"??_C@_08OHHAENPO@Hello?5A?6?$AA@")
  br label %10

7:                                                ; preds = %1
  %8 = load ptr, ptr @strA, align 8
  %9 = call i32 (ptr, ...) @printf(ptr noundef @"??_C@_03OFAPEBGM@?$CFs?6?$AA@", ptr noundef %8)
  br label %10
